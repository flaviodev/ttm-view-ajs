...
(function() {
	...
	function ttmCrudController ($scope, $window, $filter, NgTableParams, $ttmCrud, gettextCatalog) {
		...
		*/
		...
		function createObject(object,locale) { 
			$ttmCrud.postObject(object,locale, onCreateSuccess, onCreateError);					
		}

		/** onCreateSuccessFunction */
		function onCreateSuccess (status, data) {
		...
		/** onCreateErrorFunction */
		function onCreateError(status, data) {
		...
		*/
		...
		function updateObject(object) {
			$ttmCrud.putObject(object,onUpdateSuccess,onUpdateError);					
		}

		/** onUpdateSuccessFunction */
		function onUpdateSuccess (status, data) {
		...
		/** onUpdateErrorFunction */
		function onUpdateError(status, data) {
		...
		*/
		...
		function deleteObject(object) {
			...
			$ttmCrud.deleteObject(object.id,onDeleteSuccess,onDeleteError);					
		}
		
		/** onDeleteSuccessFunction */
		function onDeleteSuccess (status, data) {
		...
		/** onDeleteErrorFunction */
		function onDeleteError(status, data) {
